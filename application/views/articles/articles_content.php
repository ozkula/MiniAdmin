			...
			<thead>
		  	...
		  	<?php $no=1; for ($i=0; $i <count($show_post_data) ; $i++) { ?>
		  		<tr>
				  	...
				  	<td>
				  		<a href="<?php echo site_url("articles/edit/". $show_post_data[$i]["idarticles"]); ?>" class="btn btn-default btn-sm glyphicon glyphicon-pencil" role="button"></a>
				  		<a href="<?php echo site_url("articles/delete/". $show_post_data[$i]["idarticles"]); ?>" class="btn btn-default btn-sm glyphicon glyphicon-trash" role="button"></a>
				  	</td>
			  	</tr>
		  	<?php $no++;} ?>
		  	</tbody>
